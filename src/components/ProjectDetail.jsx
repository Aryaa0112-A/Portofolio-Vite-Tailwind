...
const handleGithubClick = (githubLink) => {
  if (githubLink === 'Private') {
    Swal.fire({
      ...
      text: 'Maaf, source code untuk proyek ini bersifat privat. Hubungi saya untuk detail lebih lanjut',
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || 'https://github.com/Aryaa0112-A',
      };
