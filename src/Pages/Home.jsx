...
const WORDS = ["Information Systems student", "Information Technology mentality"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind", "PHP", "CodeIgniter"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Aryaa0112-A" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/arya-dillah-297230254/" },
  { icon: Instagram, link: "https://www.instagram.com/0112_yaa/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Create and develop innovative, functional, and user-friendly websites for digital solutions.
                </p>
